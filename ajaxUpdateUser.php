...
<body>
	...
	if ($cari) {
		$sql = "SELECT * FROM user WHERE username LIKE '%$cari%' LIMIT $awalData, $dataPerHalaman";
	} else {
					...
					?>
						...
						?>
							<tr>
								...
								<td>
									<a class="btn btn-outline-primary btn-sm" href="editUser.php?kode=<?php echo $row['id'] ?>">Edit</a>
									<a class="btn btn-outline-danger btn-sm" href="hpsUser.php?kode=<?php echo $row["id"] ?>" id="deleteLink">Hapus</a>
								</td>
							</tr>
					<?php
							$no++;
